  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Column(
      children: [
        ...
        OutlinedButton(
          onPressed: () => ref.read(ex1CounterProvider.notifier).increment(1),
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Column(
      children: [
        ...
        const SizedBox(height: 10),
        OutlinedButton(
          onPressed: () => ref.read(ex1CounterProvider.notifier).increment(10),
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    return Column(
      children: [
        ...
        const SizedBox(height: 10),
        OutlinedButton(
          onPressed: () => ref.read(ex1CounterProvider.notifier).increment(100),
